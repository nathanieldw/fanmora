...
export default function Explore({ auth, posts, users, query = '' }: PageProps) {
    ...
    return (
        <AppLayout user={auth.user}>
            ...
            <div className="max-w-6xl mx-auto p-0 sm:px-2">
                {/* Instagram-style simple header */}
                <div className="flex justify-between items-center px-4 py-2">
                    <h1 className="text-xl font-semibold">Explore</h1>
                    {posts.data.length > 0 && <span className="text-sm text-gray-500">{posts.data.length} posts found</span>}
                </div>
                {/* Search Bar */}
                <div className="mb-6">
                    <div className="relative flex items-center bg-gray-100 dark:bg-gray-800 rounded-lg">
                        <MagnifyingGlassIcon className="ml-3 h-5 w-5 text-gray-400 dark:text-gray-500" />
                        <input
                            type="text"
                            className="w-full py-3 pl-10 pr-10 bg-gray-100 dark:bg-gray-800 border-none rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 placeholder-gray-400 dark:placeholder-gray-500 text-gray-900 dark:text-gray-100"
                    ...
                    <div className="mb-8 bg-white dark:bg-gray-900 rounded-lg shadow p-4">
                        ...
                        <div className="space-y-4">
                            {enhancedUsers.map(user => (
                                <div key={user.id} className="flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-800 p-3 rounded-lg transition-colors">
                                    <Link href={route('profile.show', { user: user.username ?? user.id })} className="flex items-center">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 dark:text-gray-100">{user.username || user.name}</h3>
                ...
                {/* Category/Topic Pills - Instagram Style */}
                <div className="flex space-x-2 overflow-x-auto py-2 px-4 mb-1 scrollbar-hide">
                    <button className="text-sm bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 px-3 py-1.5 rounded-full whitespace-nowrap transition duration-200 font-medium">For You</button>
                    <button className="text-sm bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 px-3 py-1.5 rounded-full whitespace-nowrap transition duration-200">Trending</button>
                    <button className="text-sm bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 px-3 py-1.5 rounded-full whitespace-nowrap transition duration-200">Popular</button>
                    <button className="text-sm bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 px-3 py-1.5 rounded-full whitespace-nowrap transition duration-200">Photography</button>
                    <button className="text-sm bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 px-3 py-1.5 rounded-full whitespace-nowrap transition duration-200">Art</button>
                    <button className="text-sm bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 px-3 py-1.5 rounded-full whitespace-nowrap transition duration-200">Music</button>
                    <button className="text-sm bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 px-3 py-1.5 rounded-full whitespace-nowrap transition duration-200">Fashion</button>
                </div>
                
                {/* Posts Grid */}
                {posts.data.length > 0 ? (
                    <div className="grid grid-cols-3 gap-[2px] sm:gap-[4px]">
